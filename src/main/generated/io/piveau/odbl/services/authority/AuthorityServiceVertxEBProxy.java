...
public class AuthorityServiceVertxEBProxy implements AuthorityService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public AuthorityServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public AuthorityServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  void getPeers(Handler<AsyncResult<JsonObject>> result){
    ...
    _deliveryOptions.addHeader("action", "getPeers");
  ...
  public  void postDatabase(JsonObject payload, Handler<AsyncResult<JsonObject>> result){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "postDatabase");
    _vertx.eventBus().<JsonObject>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public  void postNode(JsonObject payload, Handler<AsyncResult<JsonObject>> result){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "postNode");
    _vertx.eventBus().<JsonObject>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public  void postNewPeer(String payload, Handler<AsyncResult<JsonObject>> result){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "postNewPeer");
    _vertx.eventBus().<JsonObject>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
