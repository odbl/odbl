...
public class AdminServiceVertxEBProxy implements AdminService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public AdminServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public AdminServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
